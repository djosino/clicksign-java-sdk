...
public final class JsonApiParser {
    ...
    public static ParsedResponse parse(String json) {
        ...
        // Delegate to a minimal recursive-descent parser bundled in this package.
    ...
    public static final class ParsedResponse {
        ...
        public ParsedResponse(List<ResourceObject> data, List<ResourceObject> included, String nextLink) {
    ...
    public static final class ResourceObject {
        ...
        public Map<String, Object> relationships(){ return relationships; }

        @SuppressWarnings("unchecked")
        public String relationshipId(String name) {
            Object rel = relationships.get(name);
            if (!(rel instanceof Map)) return null;
